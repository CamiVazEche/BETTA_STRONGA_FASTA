...
def main():
    ...
    parser.add_argument("action", choices=["split_dict","longest_peptide", "logo", "seq_ids","split","composition", "art", "six_frames", "length_bar", "stats", "revcomp", "regex", "GC"], help="<-- choose one of these options to carry out on your FASTA file")
